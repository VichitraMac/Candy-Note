...
//                    layout.animate().alpha(0f).duration = 3000
        ...
        private @JvmStatic
        fun startTimer(duration: Long, toast: Toast) {
        ...
        private @JvmStatic
        fun startPulseAnimation(context: Activity, layout: View) {
            val pulseAnimation = AnimationUtils.loadAnimation(context, R.anim.pulse)
        ...
        private @JvmStatic
        fun setGravity(position: Int, toast: Toast) {
